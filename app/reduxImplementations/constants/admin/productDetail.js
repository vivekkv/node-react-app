...
export const TYPE = "PRODUCT_DETAIL";
...
export const LOAD_PRODUCT_DETAIL  = ConstantBuilder(MODULE, TYPE, "LOAD_PRODUCT_DETAIL");
export const STAR_INPUT_SUBMIT = ConstantBuilder(MODULE, TYPE, "STAR_INPUT_SUBMIT");