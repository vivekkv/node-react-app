...
import { INPUT_CHANGE, INIT_MODULE, SUBMIT_ITEM, CLEAR_FORM, EDIT_ITEM, DELETE_ITEM } from 'constants/admin/features';
...
class Features extends React.Component {
    ...
    render() {
        ...
        return <Card title="Features" icon="fa-pencil">
            ...
            <Row>
                ...
                <Form onSubmit={this.onSubmit.bind(this)} onReset={this.props.onReset}>
                    ...
                    <Row>
                        ...
                        <ColumnGroup label="Feature" size="full">
            ...
            <Row>
                ...
                <Grid showFilter={true}
                    ...
                    resultsPerPage={20} data={this.props.data.get("featuresList").toArray()}
    ...
    getGridColumnDefinition() {
        return [{ "columnName": "description", "displayName": "Feature" }];
    }
...
module.exports = connect(mapStateToProps, mapDispatchToProps)(Features);