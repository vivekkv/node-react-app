...
import { INPUT_CHANGE, INIT_MODULE, SUBMIT_ITEM, CLEAR_FORM, EDIT_ITEM, DELETE_ITEM } from 'constants/admin/suitableFor';
import { alertError } from 'utils/notification';
import validate from 'validate.js';

class SuitableFor extends React.Component {

    render() {

      
        return <Card title="Suitable For" icon="fa-pencil">
            ...
            <Row>
                ...
                <Form onSubmit={this.onSubmit.bind(this)} onReset={this.props.onReset}>
                    ...
                    <Row>
                        ...
                        <ColumnGroup label="Suitable For" size="full">
                            <Input autoFocus={true} className="form-control tlnt-input-one" name="description" value={this.props.data.get("description")} placeholder="Enter description" onChange={this.props.onChange} />
                        </ColumnGroup>
            ...
            <Row>
                ...
                <Grid showFilter={true}
                    ...
                    resultsPerPage={20} data={this.props.data.get("suitableForList").toArray()}
    ...
    getGridColumnDefinition() {
        return [{ "columnName": "description", "displayName": "Suitable For" }];
    }
...
let mapStateToProps = function (state) {
    ...
    return {
        data: Map(state.admin.suitableFor),
...
module.exports = connect(mapStateToProps, mapDispatchToProps)(SuitableFor);