...
export default class Categories extends React.Component {
    ...
    render() {
        ...
        products.unshift({ 'text': "Select product video", 'value': "0" })
        let videos = _.filter(this.props.data.get("lstLandingPage").toArray(), (i) => { return i.type == "VIDEOS" })
    ...
    getGridColumnDefinition() {
        return [{ "columnName": "additionalInfo", "displayName": "Video" }]
    }
